...
- R11：客户等级包括战略客户、普通客户。
- R12：客户健康度评分范围为 0-100，低于 60 分时触发重点关注。

### 10.3 意向管理

- R13：意向金额变化必须记录变更历史。
- R14：停滞超过 30 天的意向必须触发预警通知。
...
- R19：高优先级工单必须在 2 小时内响应。
- R20：工单超时自动升级并通知处理人主管。
- R21：工单完成后需客户确认，否则 3 天后自动完成。
- R22：同一设备 30 天内重复报修 3 次以上，自动触发质量预警。
...
- R26：设备利用率低于 20% 时标记为闲置。
- R27：设备质保到期前 30 天触发预警。
- R28：维保计划到期前 7 天自动生成维保任务。
- R29：设备报废后，关联工单必须完结。

### 10.6 经销商

- R30：经销商等级包括 A、B、C、D 四级。
- R31：经销商授权到期前 30 天触发预警。
...
- R54：大单风险等级包括高、中、低。
- R55：大单阶段包括需求确认、招标中、谈判中、合同签订、交付中，与意向阶段独立管理。
